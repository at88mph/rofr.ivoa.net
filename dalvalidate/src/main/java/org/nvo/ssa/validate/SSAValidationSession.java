...
/**
 * a validation session handler for SSA services.
 */
public class SSAValidationSession 
    extends SimpleIVOAServiceValidationSession 
{
     ...
     */
    public SSAValidationSession() throws IOException, SAXException {
        super();
    }
     ...
     *                configuration file 
     */
    public SSAValidationSession(TransformerFactory tf, Class resClass) 
     ...
     *                configuration file 
     */
    public SSAValidationSession(Configuration config, 
    ...
    protected String makeUserQuery(Properties params) {
        ...
        sb.append("&SIZE=").append(params.get("SIZE"));
