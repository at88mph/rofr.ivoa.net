...
/**
 * an AJAX-capable web application that will validate ConeSearch services
 */
public class ConeSearchValidaterWebApp extends ValidaterWebApp {

    /**
     * create the web app
     */
    public ConeSearchValidaterWebApp() { super(); }
    ...
    {
        try {
            return new ConeSearchValidationSession();
        }
