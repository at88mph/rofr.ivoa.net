...
public class TestXSLEvaluator {

   public static void main(String[] args) {

      XSLEvaluator eval = null;
      ...
      try {
        ...
        if (args.length < 1) {
            eval = new XSLEvaluator();
            eval.setDefaultResponseType("");
            eval.useStylesheet("", "data/checkConeSearch-v1_1.xsl");
            ...
            eval = new XSLEvaluator(evalconfig, null, null);

            eval.applyTests(tq, results);
        }
