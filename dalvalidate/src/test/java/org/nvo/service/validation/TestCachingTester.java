...
public class TestCachingTester {

    CachingTester tester = null;

    public TestCachingTester(TestQuery tq, Evaluator eval, File cache) {
        tester = new CachingTester(tq, eval, cache);
    }
    ...
    public static TestCachingTester makeHTTPGetTester(Configuration config, 
                                                      String baseurl, 
                                                      File file,
                                                      ResultTypes rt) 
         throws Exception
    {
        ...
        TestCachingTester out = new TestCachingTester(query, eval, file);
        return out;
    }
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            TestCachingTester testertester = 
