#  ---------------------------------------------------------------------
#   OAI specialization for VORegistry-in-a-Box.  
#
#   This is an adaptation of the following software for use by
#   IVOA Registries by Ray Plante.
#  ---------------------------------------------------------------------
...
package VORegInABox::XMLFileOAI;
